...
<html lang="en">
  <head>
    ...
    <meta name="author" content="Daniel's Website">
    ...
    <div class="navbar">
      <div class="navbar-inner">
        <div class="container-narrow">
          <a class="brand" href="https://danielgarciacano.github.io/">Daniel's Site</a>
        </div>
      </div>
    </div>
...
<div class="page-header">
  <font color="orange"> <h2>Tinkercad Car Project  </font></h2>
</div>
       
<div class="row-fluid">
  <div class="span12">
    <p>In this project we created a car usinng Tinkercad which is a digital design app.  </p>
